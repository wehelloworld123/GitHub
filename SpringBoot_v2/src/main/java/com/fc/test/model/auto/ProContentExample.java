...
public class ProContentExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andIsDelNotBetween(Integer value1, Integer value2) {
		 ...
		 public Criteria andLikeQuery(ProContent record) {
        	...
        	StringBuffer buffer=new StringBuffer();
    			 ...
    			 list.add("ifnull(book_id,'')");
						 ...
						 if(record.getBookName()!=null&&StrUtil.isNotEmpty(record.getBookName().toString())) {
    			 list.add("ifnull(book_name,'')");
    		 }
