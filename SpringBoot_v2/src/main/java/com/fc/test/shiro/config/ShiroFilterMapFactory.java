...
/*		filterChainDefinitionMap.put("/jquery.min.js", "anon");
		...
		filterChainDefinitionMap.put("/poserver.", "anon");
		...
		filterChainDefinitionMap.put("/admin/enroll", "anon");
		filterChainDefinitionMap.put("/admin/forget", "anon");
		filterChainDefinitionMap.put("/admin/confirm", "anon");
		filterChainDefinitionMap.put("/admin/reset", "anon");
		filterChainDefinitionMap.put("/index3", "anon");
