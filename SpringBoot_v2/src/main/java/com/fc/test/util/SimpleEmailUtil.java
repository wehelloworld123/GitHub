...
//        fileList.add(file2);
	...
	public static void main2(String[] args) throws Exception {
		...
		mailInfo.setUserName("xy1131095930@sina.com");
		mailInfo.setPassword("44c207187a6222e4");// 您的邮箱密码
		mailInfo.setFromAddress("xy1131095930@sina.com");
		mailInfo.setToAddress("1131095930@qq.com");
	...
	public static void main(String[] args) throws Exception {
		...
		mailInfo.setMailServerPort("25");
		mailInfo.setValidate(true);
		mailInfo.setUserName("1131095930@qq.com");
		mailInfo.setPassword("zhpotozayigbhiij");// 您的邮箱密码
		mailInfo.setFromAddress("1131095930@qq.com");
		mailInfo.setToAddress("1131095930@qq.com");
		mailInfo.setSubject("test");
		mailInfo.setContent("<div class=\"content\" style=\"\" id=\"faqDetail\">\r\n"
				+ "  <div class=\"return\" style=\"display:none;\"><a href=\"/cgi-bin/help\">首页</a> » <a href=\"/cgi-bin/help?id=28\">客户端设置</a></div>\r\n"
