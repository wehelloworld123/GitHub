...
CREATE TABLE `t_sys_user` (
  ...
  `nickname` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '昵称',
   `avatar` varchar(350) COLLATE utf8_bin DEFAULT NULL COMMENT '头像',
  `email` varchar(35) COLLATE utf8_bin DEFAULT NULL COMMENT '邮箱',
  `sex` int COLLATE utf8_bin DEFAULT 0 COMMENT '性别',
  `description` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '描述',
  `label` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '喜好标签',
  `think` int COLLATE utf8_bin DEFAULT 0 COMMENT '思想',
...
|
-- ----------------------------
-- Table structure for t_user_client
-- ----------------------------
