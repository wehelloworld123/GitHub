...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.getStorage({
      ...
      success: function(res) {
            wx.request({
             // url: 'https://www.qinyu123456.xyz/WX/returnadvandbar.do',
              method: "GET",
              data: {
                userid: "xuyong158564"
              },
              ...
              success: function (r) {
                ...
                for( var i=0;i<j;i++){
                  an.push(r.data.barandadv[i]);
                  arr.push(r.data.barandadv[i]);
                }
                //arr.push(an)
                for(i=0;i<j;i++){       
                var a1 = "content[" + i + "]";
  ...
  navigateDetail:function(e){
    ...
    var navi = "/pages/Realsesheme/Sheme_detial/Sheme_detial" + "?orderDetailType=3&iteminput" + that.data.content[messlist].iteminput + "&address=" + that.data.content[messlist].address + "&time1=" + that.data.content[messlist].timeinputone +  "&Etype=" + that.data.content[messlist].Etype + "&img=" + that.data.content[messlist].img +  "&sposor=" + that.data.content[messlist].sposor + "&detail=" + that.data.content[messlist].detail;
