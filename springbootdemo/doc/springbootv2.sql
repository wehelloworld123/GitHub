...
-- ----------------------------
DROP TABLE IF EXISTS `t_com_corporation`;
CREATE TABLE `t_com_corporation` (
  `id` varchar(25) NOT NULL AUTO_INCREMENT COMMENT '主键',
  ...
  `Institution` varchar(6) DEFAULT NULL COMMENT '所属机构',
  `star` int DEFAULT NULL COMMENT '级别',
  `CreatorUserId` varchar(50) DEFAULT NULL COMMENT '创建人',
  `CreateDate` datetime DEFAULT NULL COMMENT '创建时间',
  `like` bigint DEFAULT NULL COMMENT '点赞数',
  `IsExist` int DEFAULT NULL COMMENT '是否存续',
  PRIMARY KEY (`id`)
